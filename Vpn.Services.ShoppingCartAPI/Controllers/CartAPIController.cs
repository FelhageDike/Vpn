...
namespace Vpn.Services.ShoppingCartAPI.Controllers
{
    ...
    public class CartAPIController : Controller
    {
        ...
        {
            cartDto.CartDetails.FirstOrDefault().Product.ProductId = cartDto.CartDetails.FirstOrDefault().ProductId;
            try
            {
        ...
        public async Task<object> RemoveCoupon([FromBody] Guid userId)
        {
            try
            {
